...
from projects.mmdet3d_plugin.EAD.planner.metric_stp3 import PlanningMetric
...
class EAD(MVXTwoStageDetector):
    """EAD model. Driving_think based VAD
    """
    def __init__(self,
                 use_grid_mask=False,
        ...
        # self.cognitive_video_encoder = swin3d_b(weights=weights) 
        # self.cognitive_video_encoder.head = nn.Identity()       
